...
pipeline {
  ...
  agent {
    kubernetes {
      ...
      containerTemplates([
        containerTemplate(name: 'nodejs', image: "flowdocker/node18_builder:0.2.27", resourceRequestCpu: '1', resourceRequestMemory: '4Gi', command: 'cat', ttyEnabled: true, runAsUser: '1000'),
      ])
    }
  }
